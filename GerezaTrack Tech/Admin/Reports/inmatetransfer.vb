...
Public Class inmatetransfer
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "GerezaTrack_Tech.inmatetransfer.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedinmatetransfer
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As inmatetransfer = New inmatetransfer()
        rpt.Site = Me.Site
        Return rpt
    End Function
