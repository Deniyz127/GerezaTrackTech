...
Public Class userssreport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "GerezaTrack_Tech.userssreport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cacheduserssreport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As userssreport = New userssreport()
        rpt.Site = Me.Site
        Return rpt
    End Function
