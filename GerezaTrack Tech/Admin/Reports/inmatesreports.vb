...
Public Class inmatesreports
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "GerezaTrack_Tech.inmatesreports.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedinmatesreports
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As inmatesreports = New inmatesreports()
        rpt.Site = Me.Site
        Return rpt
    End Function
