...
Public Class outbreaksreport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "GerezaTrack_Tech.outbreaksreport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedoutbreaksreport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As outbreaksreport = New outbreaksreport()
        rpt.Site = Me.Site
        Return rpt
    End Function
