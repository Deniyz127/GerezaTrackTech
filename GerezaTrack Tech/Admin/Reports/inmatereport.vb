...
Public Class inmatereport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "GerezaTrack_Tech.inmatereport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedinmatereport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As inmatereport = New inmatereport()
        rpt.Site = Me.Site
        Return rpt
    End Function
